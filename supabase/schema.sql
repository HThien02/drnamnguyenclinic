...
CREATE POLICY "Admin can update contact settings" ON contact_settings FOR UPDATE USING (true) WITH CHECK (true);
...
VALUES (gen_random_uuid(), '0932501411', '84932501411', 'Xin chào, tôi muốn tư vấn về...', 'https://www.instagram.com/hieuthien.1802/', '123 Nguyễn Huệ, Quận 1, TP. Hồ Chí Minh', '09:00 — 19:00 (Thứ 2 - Chủ Nhật)')
