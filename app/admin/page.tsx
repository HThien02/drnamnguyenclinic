            ...
            {showServiceForm && <form onSubmit={saveService} className="mt-6 rounded-2xl border border-[#cfe2ee] bg-[#f6faff] p-4 sm:p-6">
              <div className="grid gap-5 lg:grid-cols-2">
                <div className="space-y-4 rounded-2xl border border-[#dce8f2] bg-white p-4">
                  ...
                  <label className="block text-xs font-bold text-[#0e3a63]">Slug URL *<input required value={serviceForm.slug} onChange={(e) => setServiceForm({ ...serviceForm, slug: e.target.value })} className="mt-1.5 w-full rounded-xl border border-[#c8dcea] px-3 py-2.5 text-sm font-normal" /></label>
